...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    //Create the tab names and the length!
    public String[] TabNames = {"Fridge","Shopping List","Recipes"};
    public int numOfTabs = TabNames.length;
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setWidth(displayMetrics.widthPixels/numOfTabs);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setText(TabNames[i]);
